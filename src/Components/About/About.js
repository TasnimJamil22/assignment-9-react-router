...
const About = () => {
    return (
        <div>
            <h2 className='text-primary bg-light p-2'>About Us</h2> 

            <div className='d-flex align-items-start p-2 m-3 '>
            <div className='border border-dark m-3 p-2 rounded-2 bg-success text-dark bg-opacity-25' >
            ...
            <div className='border border-dark m-3 p-2 rounded-2 bg-dark text-dark bg-opacity-25'>
            ...
            <div >
            <div className='border border-dark m-5 p-5 rounded-2 bg-light text-dark bg-opacity-25'>
            <h2 className='text-primary'>Real-life communication</h2>
            <p>
            Language is ultimately a communication tool. Supper Learning takes a functional approach by focusing on what learners actually want to do with a language.
            ...
            <div className='border border-dark m-5 p-5 rounded-2 bg-warning text-dark bg-opacity-25'>
            <h2 className='text-primary'>Continuous improvement</h2>
            <p>
            
            At Supper Learning, we're committed to improvement. Test questions are embedded throughout our courses to measure how learners are progressing — and to show where Supper Learning can improve.
